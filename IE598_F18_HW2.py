...
score_train = []
score_test = []
print ('With 4 features, the accuracy of K Nearest Neighbors model with 4 features is: ')
for k in k_range:
    ...
    plt.title('K vs Scores with 4 features')
...
for md in md_range:
    ...
    print('With 4 features, the accuracy of Decision tree model with max depth of', md, 'is ', accuracy)
    plt.scatter(md, accuracy, c='red')
    plt.title('Max Depth vs Accuracy with 4 features')
...
score_train = []
score_test = []
print ('With 2 features, the accuracy of K Nearest Neighbors model is: ')
for k in k_range:
    knn = KNeighborsClassifier(n_neighbors = k, p=2, metric='minkowski')
    ...
    print ('Test set: k =', k, 'Score:', score_test[k-1])
    plt.scatter(k, score_test[k-1], c='red')
    plt.title('Max Depth vs Accuracy')
    plt.title('K vs Scores for Standardized Test sets With 2 features')
    plt.xlabel('k value')
    plt.ylabel('scores')
plt.show()
...
for md in md_range:
    ...
    y_pred = dt.predict(X_test)
    accuracy = accuracy_score(y_test, y_pred)
    print('With 2 features, the accuracy of Decision tree model with max depth of', md, 'is ', accuracy)
    plt.scatter(md, accuracy, c='red')
    plt.title('Max Depth vs Accuracy with 2 features')
    plt.xlabel('Max Depth')
    plt.ylabel('Accuracy')
plt.show()
